    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:GridView ID="orderItemGridView1" runat="server" AutoGenerateColumns="False" CssClass="auto-style7" DataKeyNames="orderItem_id" DataSourceID="orderItemDataSource" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" Width="449px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="drink_name" HeaderText="飲料" SortExpression="drink_name" />
                    ...
                    <asp:SqlDataSource ID="orderItemDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" InsertCommand="INSERT INTO order_itemData(drink_id, order_id, num, sweet, ice) VALUES (@drink_id, @order_id, @num, @sweet, @ice)" SelectCommand="SELECT order_itemData.orderItem_id, drinkData.drink_name, order_itemData.sweet, order_itemData.ice, order_itemData.num, order_itemData.num * drinkData.drink_price AS subtotal FROM drinkData INNER JOIN order_itemData ON drinkData.drink_id = order_itemData.drink_id WHERE (order_itemData.order_id = @order_id)"  DeleteCommand="DELETE FROM order_itemData WHERE (orderItem_id = @orderItem_id)" UpdateCommand="UPDATE order_itemData SET num = @num, sweet = @sweet, ice = @ice WHERE (orderItem_id = @orderItem_id)">
                        <DeleteParameters>
